...
enum msg_hash_enums
{
   ...
   MENU_LABEL(CLOUD_SYNC_ON_CONFLICT),
   MENU_LABEL(CLOUD_SYNC_ON_CONFLICT_IGNORE),
   MENU_LABEL(CLOUD_SYNC_ON_CONFLICT_LOCAL_WINS),
   MENU_LABEL(CLOUD_SYNC_ON_CONFLICT_SERVER_WINS),
