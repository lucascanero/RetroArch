...
MSG_HASH(
   ...
   "Automatic: Syncs when RetroArch starts and when a core is unloaded. Manual: Only syncs when 'Sync Now' is pressed."
   )
MSG_HASH(
   MENU_ENUM_LABEL_VALUE_CLOUD_SYNC_MODE_MANUAL,
   "Manual"
   )
MSG_HASH(
   MENU_ENUM_LABEL_VALUE_CLOUD_SYNC_MODE_AUTOMATIC,
   "Automatic"
   )
MSG_HASH(
